...
export const BoxStats = () => {
	...
	const statsData: StatsDataType = {
		experience: {number: 6, text: 'month of', textSpan: 'experience',},
		projects: {number: 4, text: 'completed', textSpan: 'projects'},
		customers: {number: 10, text: 'happy', textSpan: 'customers'},
		won: {number: 0, text: 'awards', textSpan: 'won'},
	}
